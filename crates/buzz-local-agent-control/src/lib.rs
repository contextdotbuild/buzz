...
const FORWARD_RELEASE_ID: &str = "f7676f372d6b4628a02fe304fea59e9a8c84504b";
const FORWARD_SOURCE_TREE: &str = "48b39379c20ace3252c0e82b184eeb8259aa814e";
const FORWARD_MANIFEST_SHA256: &str =
    "35ef710566a97c25b8439b3a2fae49f07aa6df84d761e21d42d5743b267d7fc0";
...
const FORWARD_LIBEXEC_SHA256: &str =
    "4324877e56a0dac1798200e969ff1e9f39569891018467d304f79b262fae8e99";
const FORWARD_LIBEXEC_SIZE: u64 = 13_899_056;
const FORWARD_MCP_SHA256: &str = "a9c277cc68e715ece8e596056d2ebee6300da58cba7a6c387bb5e7d9d63fec32";
const FORWARD_MCP_SIZE: u64 = 20_060_000;
const FORWARD_TOOLCHAIN: &str = "rustc 1.95.0";
const ROLLBACK_RELEASE_ID: &str = "135ebc3514f2165f714dae90df3eae67e8b22515";
const ROLLBACK_SOURCE_TREE: &str = "6bba8e8a9a0a655f331d906091f9bc62b2420c82";
const ROLLBACK_MANIFEST_SHA256: &str =
    "e3c1500a21294fc6cc65872447452b1c2d966a92e4e8b438cd5eb55f6374f2d7";
const ROLLBACK_COMMAND_SHA256: &str =
    "8d2720ddde69d25a0d21c28bdd1308cf524243d8cdb86781965a7ade98858745";
const ROLLBACK_COMMAND_SIZE: u64 = 184;
const ROLLBACK_LIBEXEC_SHA256: &str =
    "d8e37d125de23e1a305cb1ac9bb0660e55eb52b984ea863ff0dbae8232c9a197";
const ROLLBACK_LIBEXEC_SIZE: u64 = 13_899_056;
const ROLLBACK_MCP_SHA256: &str =
    "2e9c2ac7d37a533ca4957d447f2b54e5dd7884821421c9149c41ac4749379359";
const ROLLBACK_MCP_SIZE: u64 = 20_059_680;
