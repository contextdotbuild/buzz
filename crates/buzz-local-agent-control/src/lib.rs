...
const FORWARD_RELEASE_ID: &str = "374ba84b2e0fb7dcb5cbdcfdbc3c7cedccfcb743";
const FORWARD_SOURCE_TREE: &str = "3f58c1e9d1c7f09209f4531dbbbf24a559543edb";
const FORWARD_MANIFEST_SHA256: &str =
    "750b1a3efb12d096b0b1c5bb4760847621c47abe25fad99deeefc7fed9b2e591";
...
const FORWARD_LIBEXEC_SHA256: &str =
    "73442a253d29d253789efbbd7a44f1206f0b7dc4fbead677575ee80677669f5a";
const FORWARD_LIBEXEC_SIZE: u64 = 13_872_880;
const FORWARD_MCP_SHA256: &str = "281e3d284fb3cff16a6326d1c99679e87b5bd76540db70666ea35163b7ba304c";
const FORWARD_MCP_SIZE: u64 = 20_096_080;
const FORWARD_TOOLCHAIN: &str = "rustc 1.95.0";
const ROLLBACK_RELEASE_ID: &str = "8a68807db66126f27b78464855e44edf964f89c2";
const ROLLBACK_SOURCE_TREE: &str = "ced178a27cb69ec247f8c95b2fd4d25c7b440337";
const ROLLBACK_MANIFEST_SHA256: &str =
    "c613b92161a2234322183135d30216ba43594648725ad60a0e0f4d253bd9bd5e";
const ROLLBACK_COMMAND_SHA256: &str =
    "8d2720ddde69d25a0d21c28bdd1308cf524243d8cdb86781965a7ade98858745";
const ROLLBACK_COMMAND_SIZE: u64 = 184;
const ROLLBACK_LIBEXEC_SHA256: &str =
    "a7757e6535b2632dc9e673b7558ec3da9c4b8dbac7de7f987fc4ec47f3643e95";
const ROLLBACK_LIBEXEC_SIZE: u64 = 14_947_904;
const ROLLBACK_MCP_SHA256: &str =
    "e300f64f6ffc865e3a44fa7825d31140f0920680c5972675274ff10545108235";
const ROLLBACK_MCP_SIZE: u64 = 20_956_416;
