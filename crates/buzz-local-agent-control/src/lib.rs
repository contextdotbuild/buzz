...
const FORWARD_RELEASE_ID: &str = "974756b9df0333817f3c4d5fd392629ea8e90819";
const FORWARD_SOURCE_TREE: &str = "e25a86b7a7377d15fea5ad61a3b4d28a1f82dc43";
const FORWARD_MANIFEST_SHA256: &str =
    "c46bd62216f41873e3898f634f68731ae8d6c480e393da7b7ce7bc2012f5a10e";
...
const FORWARD_LIBEXEC_SHA256: &str =
    "22acc06078206e2d7b3d20a282123257005183aad873d8059ed8dc9b62d4a879";
const FORWARD_LIBEXEC_SIZE: u64 = 13_872_880;
const FORWARD_MCP_SHA256: &str = "c8e1979d8455c08698fd7917f5e16ca3919b6cf86d52ff78bd0097d0b4b15407";
const FORWARD_MCP_SIZE: u64 = 20_076_336;
const FORWARD_TOOLCHAIN: &str = "rustc 1.95.0";
const ROLLBACK_RELEASE_ID: &str = "374ba84b2e0fb7dcb5cbdcfdbc3c7cedccfcb743";
const ROLLBACK_SOURCE_TREE: &str = "3f58c1e9d1c7f09209f4531dbbbf24a559543edb";
...
const ROLLBACK_LIBEXEC_SIZE: u64 = 13_872_880;
const ROLLBACK_MCP_SHA256: &str =
    "281e3d284fb3cff16a6326d1c99679e87b5bd76540db70666ea35163b7ba304c";
const ROLLBACK_MCP_SIZE: u64 = 20_096_080;
