...
const FORWARD_RELEASE_ID: &str = "61dc5adf30c3ad17eb824395eed0be0313d200c3";
const FORWARD_SOURCE_TREE: &str = "47f67a7db57d241b654f97ea03fe20f035776dc3";
const FORWARD_MANIFEST_SHA256: &str =
    "638046edbdbae3ae8add3b4de9618cb0ca20b9c3f1d0b9debe647abeae09a918";
...
const FORWARD_LIBEXEC_SHA256: &str =
    "08ce442e3abd8ffb8535de6e00bb4148bce9fbb44d6d77d40ca3d0d2953c6f01";
const FORWARD_LIBEXEC_SIZE: u64 = 13_872_880;
const FORWARD_MCP_SHA256: &str = "2a5f2c3b3f7a9c58ae06a6ccebec322b131e67222a0192947bdad3945ca4c19a";
const FORWARD_MCP_SIZE: u64 = 20_059_952;
const FORWARD_TOOLCHAIN: &str = "rustc 1.95.0";
const ROLLBACK_RELEASE_ID: &str = "974756b9df0333817f3c4d5fd392629ea8e90819";
const ROLLBACK_SOURCE_TREE: &str = "e25a86b7a7377d15fea5ad61a3b4d28a1f82dc43";
...
const ROLLBACK_MCP_SHA256: &str =
    "c8e1979d8455c08698fd7917f5e16ca3919b6cf86d52ff78bd0097d0b4b15407";
const ROLLBACK_MCP_SIZE: u64 = 20_076_336;
