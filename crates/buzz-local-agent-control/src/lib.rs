...
const FORWARD_RELEASE_ID: &str = "08ffe5794f9c3c28fcc1389f26e56d4b6b0f3c81";
const FORWARD_SOURCE_TREE: &str = "6a25d0f90ed0d9b869be73024fd00efb4d4930b3";
const FORWARD_MANIFEST_SHA256: &str =
    "e3c97699e89eb7ef9acb1c2695db0849dd9b5bd0819fc21b2c181e6e822d1194";
...
const FORWARD_LIBEXEC_SHA256: &str =
    "eb6c30416dc8c4c919b92a85f38d2ef9ce4ab6554c32a459486c684702ee6892";
const FORWARD_LIBEXEC_SIZE: u64 = 13_922_416;
const FORWARD_MCP_SHA256: &str = "e2923a3f7a93de5e283f126392208ef6b43ebec768c308eba9362c05fbc7eb2a";
const FORWARD_MCP_SIZE: u64 = 20_125_344;
const FORWARD_TOOLCHAIN: &str = "rustc 1.95.0";
const ROLLBACK_RELEASE_ID: &str = "05de5f5dd50cbe1568ef5058514267952a5fd85b";
const ROLLBACK_SOURCE_TREE: &str = "e40416129d703db742fec2803c7293ccad1e825b";
const ROLLBACK_MANIFEST_SHA256: &str =
    "6e4861251db64c9290c6fe1574324b29d50423a6a4d26a9de78cfc395b521efe";
const ROLLBACK_COMMAND_SHA256: &str =
    "8d2720ddde69d25a0d21c28bdd1308cf524243d8cdb86781965a7ade98858745";
const ROLLBACK_COMMAND_SIZE: u64 = 184;
const ROLLBACK_LIBEXEC_SHA256: &str =
    "5f33730b0e046449ed9d8dbaa7ff5177dede0f3839a7095b39ddb07905ed9877";
const ROLLBACK_LIBEXEC_SIZE: u64 = 13_872_848;
const ROLLBACK_MCP_SHA256: &str =
    "bb1bcb49de019b59ae5359b3a6e80ff589eb768ba5fadf5264402c10ef37a2cf";
const ROLLBACK_MCP_SIZE: u64 = 20_076_144;
